...
define enable(@windows_server) do
    ...
    call set_server_names(@windows_server)
end
...
define set_server_names(@windows_server) do
    call get_server_order() retrieve $current_count
...
define get_server_order() return $current_count do
